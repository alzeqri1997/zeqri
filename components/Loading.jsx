...
const Loading = () => {
  return (
    ...
    <div className='loading' >
      <div class="loadingio-spinner-chunk-asn2yzkabo"><div class="ldio-vpq9zc0bn6">
        <div><div><div></div><div></div><div></div><div></div></div></div>
        </div>
      </div>
      <span className='loading__text'  >just, hold up a second {" "}
      <svg width="16" height="16" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_7_29219)">
          <path d="M36 18C36 27.941 27.941 36 18 36C8.059 36 0 27.941 0 18C0 8.059 8.059 0 18 0C27.941 0 36 8.059 36 18Z" fill="#FFCC4D" />
          <path d="M7 23C9.76142 23 12 20.7614 12 18C12 15.2386 9.76142 13 7 13C4.23858 13 2 15.2386 2 18C2 20.7614 4.23858 23 7 23Z" fill="#FF7892" />
          <path d="M29 23C31.7614 23 34 20.7614 34 18C34 15.2386 31.7614 13 29 13C26.2386 13 24 15.2386 24 18C24 20.7614 26.2386 23 29 23Z" fill="#FF7892" />
